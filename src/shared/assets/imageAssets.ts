export const imageAssets = {
  ...
  lookSculptedHd: require("./images/look-sculpted-hd.png"),
  lookSunkissed: require("./images/look-sunkissed.png"),
  productLipstick: require("./images/product-lipstick.png"),
  productPrimer: require("./images/product-primer.png")
} as const;
