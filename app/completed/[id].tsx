...
const styles = StyleSheet.create({
  ...
  compare: { height: 400, borderRadius: radius.xl, overflow: "hidden", backgroundColor: colors.surfaceMuted },
  ...
  scoreCard: { flex: 1, alignItems: "center", paddingVertical: spacing.xl },
  ...
  half: { flex: 1 },
  sectionTitle: { color: colors.ink, fontSize: 20, fontWeight: "900", marginTop: 30, marginBottom: spacing.md },
  product: { flexDirection: "row", alignItems: "center", gap: spacing.md, marginBottom: spacing.md, padding: spacing.md },
  productImage: { width: 76, height: 76, borderRadius: radius.md, backgroundColor: colors.blushSoft, alignItems: "center", justifyContent: "center" },
