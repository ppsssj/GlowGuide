      ...
      <View style={styles.container}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
          <View style={styles.compare}>
            <Image source={look.hero} style={styles.compareImage} />
            ...
            <View style={styles.sliderLine}><View style={styles.sliderButton}><Text style={styles.sliderText}>↕</Text></View></View>
          </View>
          ...
          <View style={styles.scoreGrid}>
            ...
            <Card style={styles.scoreCard}>
              <View style={styles.achievement}><Text style={styles.achievementIcon}>★</Text></View>
              <Text style={styles.scoreTitle}>Achievement</Text>
              <Text style={styles.scoreMeta}>Consistency Master</Text>
            </Card>
          </View>
          <View style={styles.actions}>
            <AppButton label="Save to My Looks" />
            <View style={styles.actionRow}>
              <AppButton label="Try Again" variant="secondary" onPress={() => router.push(`/coaching/${look.id}`)} style={styles.half} />
              <AppButton label="Share" variant="secondary" style={styles.half} />
            </View>
          </View>
          <Text style={styles.sectionTitle}>Products Used</Text>
          {look.products.map((product) => (
            <Card key={product.id} style={styles.product}>
              <View style={styles.productImage}><Text style={styles.productGlyph}>◻</Text></View>
...
const styles = StyleSheet.create({
  ...
  sliderText: { color: colors.primary, fontSize: 18, fontWeight: "900" },
  ...
  achievementIcon: { color: colors.primary, fontSize: 30 },
  ...
  productGlyph: { color: colors.primary, fontSize: 24 },
  productCopy: { flex: 1 },
